...
void lineTest( void ) {
    ...
    camera_position = Vector3( 0.0, 0.0, -10.0 );
...
void circleTest( void ) {
    ...
    camera_position = Vector3( 0.0, 0.0, -3.0 );
...
void sineTest( void ) {
    ...
    camera_position = Vector3( -PI, 0.0, -6.0 );
...
void compressedsineandsineTest( void ) {
    ...
    camera_position = Vector3( -(PI+PI/2.0), 0.0, -8.0 );
...
void dblimmelmannTest( void ) {
    ...
    camera_position = Vector3( 0.0, -1.0, -4.0 );
...
void draw_actor( void ) {
    ...
    glTranslated( actor_position.x(), actor_position.y(), actor_position.z() );
    glutSolidTeapot(1.0);
