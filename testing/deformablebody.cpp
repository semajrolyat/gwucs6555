...
DeformableBody *start, *end;

DeformableBody *tetrahedron;

Material *material1, *material2;

void initShapes( void ) {
    title = "Deformable Body";
    filetitle = "deformablebody";
    ...
    scene.camera.viewpoint = Vector3( 0.0, -1.0, 1.0 );
    scene.camera.up = Vector3( 0.0, 1.0, 0.0 );
    */
    scene.camera.project();

    //start = (DeformableBody*)MeshLoader::loadPly( "mesh_start_ascii.ply" );
    //end = (DeformableBody*)MeshLoader::loadPly( "mesh_end_ascii.ply" );

    material1 = new Material(true);
    material2 = new Material(true);

    tetrahedron = MeshLoader::tetrahedron( );
    //tetrahedron->material = material1;
