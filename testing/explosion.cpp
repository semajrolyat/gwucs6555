...
void initScene( void ) {
    ...
    unsigned int particles = 1e5;

    cloud.insert( ParticleCloud::sphere( &ParticleCloud::flame, prototype, center, max_radius, particles ) );

    cloud.insert( ParticleCloud::ring( &ParticleCloud::flame, prototype, center, 1.0, 0.4, particles ) );

    cloud.insert( ParticleCloud::ring( &ParticleCloud::orange, prototype, center, 0.6, 0.3, particles ) );

    cloud.insert( ParticleCloud::ring( &ParticleCloud::white, prototype, center, 0.4, 0.2, particles ) );

    cloud.insert( ParticleCloud::shell( &ParticleCloud::flame, prototype, center, 1.0, 0.4, particles ) );

    cloud.insert( ParticleCloud::shell( &ParticleCloud::white, prototype, center, 0.2, 0.1, particles ) );

    cloud.insert( ParticleCloud::shell( &ParticleCloud::flame, prototype, center, 0.6, 0.1, particles ) );

    cloud.insert( ParticleCloud::shell( &ParticleCloud::black, prototype, center, 1.0, 0.95, particles ) );

    cloud.position = center;
    cloud.colorfun = &ParticleCloud::flame;
